...
# ANALISIS JALISCO
## Casos positivos de COVID-19 por fecha de inicio de síntomas en datos SSA Federal
...
#Para el caso de los datos por fecha de sintomas, el valor de Rt se calcula para el momento de epidemia hace dos semanas
...
# par(mgp=c(3,1,0))
# 
# cpen_ymax <- 1.1 * max(datos_municipio$Rt, na.rm = TRUE)
# cpen_ymin <- 0.9 * min(datos_municipio$Rt, na.rm = TRUE)
# 
