...
mi_grafica <- function (nivel, datos_1, datos_2, metadatos_1, modo = 1) {
  ...
  mi_barplot <- barplot(datos_1[nivel,1:length_visulal],
        ...
        horiz = FALSE, las = 1,
        col = "white",
        ylab = "casos diarios registrados por 100 mil habitantes", 
        names.arg = ""
        )
  ...
  polygon(x = c(mi_barplot[which(colnames_vector == "30-10-2020")],
          ...
          y = c(0,30,30,0),
          col = "blue", border = NA, density = 10, angle = 45)  
  abline(v = mi_barplot[which(colnames_vector == "01-06-2020")], col = "pink", lty = 2)
  abline(v = mi_barplot[which(colnames_vector == "15-06-2020")], col = "pink", lty = 2)    
  polygon(x = c(mi_barplot[which(colnames_vector == "01-06-2020")],
                ...
                mi_barplot[which(colnames_vector == "15-06-2020")]),
          y = c(0,30,30,0),
          col = "pink", border = NA, density = 10, angle = 45)
  abline(v = mi_barplot[which(colnames_vector == "20-07-2020")], col = "pink", lty = 2)
  abline(v = mi_barplot[which(colnames_vector == "17-08-2020")], col = "pink", lty = 2)    
...
par(mfrow = c(11,1), mar = c(1,5,1,1))
