...
# ANALISIS MÉXICO
## Casos positivos de COVID-19 por fecha de inicio de sintomas
...
##### Casos con primeros sintomas presentados desde ayer: **`r round(casos_nac[1] - casos_nac[2], 0)`** (**`r round(100 * (casos_nac[1] - casos_nac[2]) / casos_nac[2], 2)`%**). 
...
dos semanas antes de la fecha del reporte."
...
La estimación incluye los casos confirmados con fecha de presentación de sintomas durante las últimas dos semanas y la fracción de los casos con la prueba por procesar tomada durante las últimas dos semanas proporcional a la proporci+pn de los podsitivos en la semana anterior.
