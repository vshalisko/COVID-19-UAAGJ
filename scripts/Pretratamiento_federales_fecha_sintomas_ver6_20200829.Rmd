...
fecha_mas_antigua <- min(as.Date(d_hoy$FECHA_SINTOMAS))
...
for(i in 0:n) {
  ...
  d <- d_hoy[d_hoy$FECHA_SINTOMAS == as.character(fecha_d),]
...
casos_metropolitanas_acc <- datos_metropolitanas[,casos_fechas[length(casos_fechas):1]]
neg_metropolitanas_acc <- datos_metropolitanas[,neg_fechas[length(casos_fechas):1]]
pend_metropolitanas_acc <- datos_metropolitanas[,pend_fechas[length(casos_fechas):1]]
def_metropolitanas_acc <- datos_metropolitanas[,def_fechas[length(casos_fechas):1]]
hosp_metropolitanas_acc <- datos_metropolitanas[,hosp_fechas[length(casos_fechas):1]]
uci_metropolitanas_acc <- datos_metropolitanas[,uci_fechas[length(casos_fechas):1]]
...
datos_metropolitanas_acc <- cbind(datos_metropolitanas[,1:8],
                    convertir_acumulado(casos_metropolitanas_acc),
                    convertir_acumulado(neg_metropolitanas_acc),
                    convertir_acumulado(pend_metropolitanas_acc),
                    convertir_acumulado(def_metropolitanas_acc),
                    convertir_acumulado(hosp_metropolitanas_acc),
                    convertir_acumulado(uci_metropolitanas_acc)
                    )
...
str(datos_metropolitanas)
str(datos_metropolitanas_acc)

saveRDS(datos_estado_acc, paste0("object_estado_FS_",fecha_formato,".rds"))
saveRDS(datos_municipio_acc, paste0("object_municipio_FS_",fecha_formato,".rds"))
saveRDS(datos_metropolitanas_acc, paste0("object_metropolitanos_FS_",fecha_formato,".rds"))
```
