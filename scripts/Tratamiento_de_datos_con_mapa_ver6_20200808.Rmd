...
##### Aumento durante la última semana (desde `r fecha_formato - 7` hasta `r fecha_formato`): `r casos_nac[1] - casos_nac[8]` (`r `%).
##### Aumento durante la semana anterior `r ` (`r `%).
##### Aumento durante las últimas dos semanas `r ` (`r `%).
...
DT::datatable(datos_estado[,c("Estado", "casos200806", "casos200807", "casos200808")], 
         colnames = c("Estados","Casos ayer","Casos hoy"),
