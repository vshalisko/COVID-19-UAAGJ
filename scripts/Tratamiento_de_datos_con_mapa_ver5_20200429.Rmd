---
title: "Tratamiento datos COVID-19 México 29/04/2020"
author: "Viacheslav Shalisko en colaboración con E. Santana, R. Castillo-Aja, L. Valdivia-Orneals"
date: "29/4/2020"
output:
  html_document: 
    self_contained: true
...
fecha_formato <- "2020-04-29"

datos <- read.csv("200429COVID19MEXICO.csv")
datos_ayer <- read.csv("200428COVID19MEXICO.csv")
datos_hace14 <- read.csv("200415COVID19MEXICO.csv")
...
datos_positivos_UCI_ayer_hace14 <- datos_hace14[datos_hace14$RESULTADO == 1 & datos_hace14$UCI == 1,]
...
cpen <- merge(x = casos_por_estado, y = casos_por_estado_ayer, by = "estados")
cpen <- merge(x = cpen, y = casos_por_estado_hace14, by = "estados")
...
cpen <- merge(x = cpen, y = defunciones_por_estado, by = "estados")
cpen <- merge(x = cpen, y = defunciones_por_estado_ayer, by = "estados")
cpen <- merge(x = cpen, y = defunciones_por_estado_hace14, by = "estados")
...
npen <- merge(x = npen, y = cpen[,c("estados","defunciones","defunciones_ayer","aumento_defunciones","defunciones_por_100k")], by = "estados", all.x = TRUE)
