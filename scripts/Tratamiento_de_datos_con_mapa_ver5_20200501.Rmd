---
title: "Tratamiento datos COVID-19 México 01/05/2020"
...
```{r echo = FALSE}
fecha <- "1 de mayo del 2020"
fecha_formato <- "2020-05-01"

datos <- read.csv("200501COVID19MEXICO.csv")
datos_ayer <- read.csv("200430COVID19MEXICO.csv")
datos_hace14 <- read.csv("200417COVID19MEXICO.csv")
...
datos_defunciones_hace14 <- datos_hace14[datos_hace14$RESULTADO == 1 & datos_hace14$FECHA_DEF != '',]
