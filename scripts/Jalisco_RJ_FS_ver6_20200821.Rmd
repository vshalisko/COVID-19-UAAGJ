...
# ANALISIS JALISCO
## Casos positivos de COVID-19 por fecha de inicio de síntomas en datos RADAR JALISCO
...
Nota: el calculo de Rt solo es posible en municipios con significativa acumulacion de casos.
"
...
La secuencia de particiones en las barras corresponde a la lista de municipios por el núemero de caso nuevos durante las útlimas dos semanas.
